...
assert.match(appJs, /\['mando','Centro de mando'\],\['tareas',mainLabel\],\['reporte','Reporte'\],\['historial','Historial'\],\['kanban','Kanban'\],\['calendario','Calendario'\],\['gantt','Gantt'\],\['pipeline','Pipeline'\]/);
