...
assert.match(appJs, /\['mando','Centro de Control'\],\['ejecucion','Ejecución'\],\['tareas',mainLabel\],\['reporte','Reporte'\],\['historial','Historial'\],\['kanban','Kanban'\],\['calendario','Calendario'\],\['gantt','Gantt'\],\['pipeline','Pipeline'\]/);
