...
assert.match(html, /styles\.css\?v=2\.7\.0|styles\.css\?v=2\.8\.[0-5]|styles\.css\?v=2\.(?:9\.[01]|10\.[0-6])/);
assert.match(html, /app\.js\?v=2\.7\.0|app\.js\?v=2\.8\.[0-5]|app\.js\?v=2\.(?:9\.[01]|10\.[0-6])/);
